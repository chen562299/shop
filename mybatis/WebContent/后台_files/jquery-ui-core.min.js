 ...
 */
jQuery.effects||(function(i,f){i.effects={};i.each(["backgroundColor","borderBottomColor","borderLeftColor","borderRightColor","borderTopColor","borderColor","color","outlineColor"],function(p,o){i.fx.step[o]=function(q){if(!q.colorInit){q.start=n(q.elem,o);q.end=l(q.end);q.colorInit=true}q.elem.style[o]="rgb("+Math.max(Math.min(parseInt((q.pos*(q.end[0]-q.start[0]))+q.start[0],10),255),0)+","+Math.max(Math.min(parseInt((q.pos*(q.end[1]-q.start[1]))+q.start[1],10),255),0)+","+Math.max(Math.min(parseInt((q.pos*(q.end[2]-q.start[2]))+q.start[2],10),255),0)+")"}});function l(p){var o;if(p&&p.constructor==Array&&p.length==3){return p}if(o=/rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/.exec(p)){return[parseInt(o[1],10),parseInt(o[2],10),parseInt(o[3],10)]}if(o=/rgb\(\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*\)/.exec(p)){return[parseFloat(o[1])*2.55,parseFloat(o[2])*2.55,parseFloat(o[3])*2.55]}if(o=/#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(p)){return[parseInt(o[1],16),parseInt(o[2],16),parseInt(o[3],16)]}if(o=/#([a-fA-F0-9])([a-fA-F0-9])([a-fA-F0-9])/.exec(p)){return[parseInt(o[1]+o[1],16),parseInt(o[2]+o[2],16),parseInt(o[3]+o[3],16)]}if(o=/rgba\(0, 0, 0, 0\)/.exec(p)){return b.transparent}return b[i.trim(p).toLowerCase()]}function n(q,o){var p;do{p=(i.curCSS||i.css)(q,o);if(p!=""&&p!="transparent"||i.nodeName(q,"body")){break}o="backgroundColor"}while(q=q.parentNode);return l(p)}var b={aqua:[0,255,255],azure:[240,255,255],beige:[245,245,220],black:[0,0,0],blue:[0,0,255],brown:[165,42,42],cyan:[0,255,255],darkblue:[0,0,139],darkcyan:[0,139,139],darkgrey:[169,169,169],darkgreen:[0,100,0],darkkhaki:[189,183,107],darkmagenta:[139,0,139],darkolivegreen:[85,107,47],darkorange:[255,140,0],darkorchid:[153,50,204],darkred:[139,0,0],darksalmon:[233,150,122],darkviolet:[148,0,211],fuchsia:[255,0,255],gold:[255,215,0],green:[0,128,0],indigo:[75,0,130],khaki:[240,230,140],lightblue:[173,216,230],lightcyan:[224,255,255],lightgreen:[144,238,144],lightgrey:[211,211,211],lightpink:[255,182,193],lightyellow:[255,255,224],lime:[0,255,0],magenta:[255,0,255],maroon:[128,0,0],navy:[0,0,128],olive:[128,128,0],orange:[255,165,0],pink:[255,192,203],purple:[128,0,128],violet:[128,0,128],red:[255,0,0],silver:[192,192,192],white:[255,255,255],yellow:[255,255,0],transparent:[255,255,255]};var g=["add","remove","toggle"],d={border:1,borderBottom:1,borderColor:1,borderLeft:1,borderRight:1,borderTop:1,borderWidth:1,margin:1,padding:1};function h(){var r=document.defaultView?document.defaultView.getComputedStyle(this,null):this.currentStyle,s={},p,q;if(r&&r.length&&r[0]&&r[r[0]]){var o=r.length;while(o--){p=r[o];if(typeof r[p]=="string"){q=p.replace(/\-(\w)/g,function(t,u){return u.toUpperCase()});s[q]=r[p]}}}else{for(p in r){if(typeof r[p]==="string"){s[p]=r[p]}}}return s}function c(p){var o,q;for(o in p){q=p[o];if(q==null||i.isFunction(q)||o in d||(/scrollbar/).test(o)||(!(/color/i).test(o)&&isNaN(parseFloat(q)))){delete p[o]}}return p}function j(o,q){var r={_:0},p;for(p in q){if(o[p]!=q[p]){r[p]=q[p]}}return r}i.effects.animateClass=function(o,p,r,q){if(i.isFunction(r)){q=r;r=null}return this.queue(function(){var v=i(this),s=v.attr("style")||" ",w=c(h.call(this)),u,t=v.attr("class")||"";i.each(g,function(x,y){if(o[y]){v[y+"Class"](o[y])}});u=c(h.call(this));v.attr("class",t);v.animate(j(w,u),{queue:false,duration:p,easing:r,complete:function(){i.each(g,function(x,y){if(o[y]){v[y+"Class"](o[y])}});if(typeof v.attr("style")=="object"){v.attr("style").cssText="";v.attr("style").cssText=s}else{v.attr("style",s)}if(q){q.apply(this,arguments)}i.dequeue(this)}})})};i.fn.extend({_addClass:i.fn.addClass,addClass:function(p,o,r,q){return o?i.effects.animateClass.apply(this,[{add:p},o,r,q]):this._addClass(p)},_removeClass:i.fn.removeClass,removeClass:function(p,o,r,q){return o?i.effects.animateClass.apply(this,[{remove:p},o,r,q]):this._removeClass(p)},_toggleClass:i.fn.toggleClass,toggleClass:function(q,p,o,s,r){if(typeof p=="boolean"||p===f){if(!o){return this._toggleClass(q,p)}else{return i.effects.animateClass.apply(this,[(p?{add:q}:{remove:q}),o,s,r])}}else{return i.effects.animateClass.apply(this,[{toggle:q},p,o,s])}},switchClass:function(o,q,p,s,r){return i.effects.animateClass.apply(this,[{add:q,remove:o},p,s,r])}});i.extend(i.effects,{version:"@VERSION",save:function(p,q){for(var o=0;o<q.length;o++){if(q[o]!==null){p.data("ec.storage."+q[o],p[0].style[q[o]])}}},restore:function(p,q){for(var o=0;o<q.length;o++){if(q[o]!==null){p.css(q[o],p.data("ec.storage."+q[o]))}}},setMode:function(o,p){if(p=="toggle"){p=o.is(":hidden")?"show":"hide"}return p},getBaseline:function(p,q){var r,o;switch(p[0]){case"top":r=0;break;case"middle":r=0.5;break;case"bottom":r=1;break;default:r=p[0]/q.height}switch(p[1]){case"left":o=0;break;case"center":o=0.5;break;case"right":o=1;break;default:o=p[1]/q.width}return{x:o,y:r}},createWrapper:function(o){if(o.parent().is(".ui-effects-wrapper")){return o.parent()}var p={width:o.outerWidth(true),height:o.outerHeight(true),"float":o.css("float")},s=i("<div></div>").addClass("ui-effects-wrapper").css({fontSize:"100%",background:"transparent",border:"none",margin:0,padding:0}),r=document.activeElement;try{r.id}catch(q){r=document.body}o.wrap(s);if(o[0]===r||i.contains(o[0],r)){i(r).focus()}s=o.parent();if(o.css("position")=="static"){s.css({position:"relative"});o.css({position:"relative"})}else{i.extend(p,{position:o.css("position"),zIndex:o.css("z-index")});i.each(["top","left","bottom","right"],function(t,u){p[u]=o.css(u);if(isNaN(parseInt(p[u],10))){p[u]="auto"}});o.css({position:"relative",top:0,left:0,right:"auto",bottom:"auto"})}return s.css(p).show()},removeWrapper:function(o){var p,q=document.activeElement;if(o.parent().is(".ui-effects-wrapper")){p=o.parent().replaceWith(o);if(o[0]===q||i.contains(o[0],q)){i(q).focus()}return p}return o},setTransition:function(p,r,o,q){q=q||{};i.each(r,function(t,s){var u=p.cssUnit(s);if(u[0]>0){q[s]=u[0]*o+u[1]}});return q}});function e(p,o,q,r){if(typeof p=="object"){r=o;q=null;o=p;p=o.effect}if(i.isFunction(o)){r=o;q=null;o={}}if(typeof o=="number"||i.fx.speeds[o]){r=q;q=o;o={}}if(i.isFunction(q)){r=q;q=null}o=o||{};q=q||o.duration;q=i.fx.off?0:typeof q=="number"?q:q in i.fx.speeds?i.fx.speeds[q]:i.fx.speeds._default;r=r||o.complete;return[p,o,q,r]}function m(o){if(!o||typeof o==="number"||i.fx.speeds[o]){return true}if(typeof o==="string"&&!i.effects[o]){return true}return false}i.fn.extend({effect:function(r,q,t,v){var p=e.apply(this,arguments),s={options:p[1],duration:p[2],callback:p[3]},u=s.options.mode,o=i.effects[r];if(i.fx.off||!o){if(u){return this[u](s.duration,s.callback)}else{return this.each(function(){if(s.callback){s.callback.call(this)}})}}return o.call(this,s)},_show:i.fn.show,show:function(p){if(m(p)){return this._show.apply(this,arguments)}else{var o=e.apply(this,arguments);o[1].mode="show";return this.effect.apply(this,o)}},_hide:i.fn.hide,hide:function(p){if(m(p)){return this._hide.apply(this,arguments)}else{var o=e.apply(this,arguments);o[1].mode="hide";return this.effect.apply(this,o)}},__toggle:i.fn.toggle,toggle:function(p){if(m(p)||typeof p==="boolean"||i.isFunction(p)){return this.__toggle.apply(this,arguments)}else{var o=e.apply(this,arguments);o[1].mode="toggle";return this.effect.apply(this,o)}},cssUnit:function(o){var p=this.css(o),q=[];i.each(["em","px","%","pt"],function(r,s){if(p.indexOf(s)>0){q=[parseFloat(p),s]}});return q}});var k={};i.each(["Quad","Cubic","Quart","Quint","Expo"],function(p,o){k[o]=function(q){return Math.pow(q,p+2)}});i.extend(k,{Sine:function(o){return 1-Math.cos(o*Math.PI/2)},Circ:function(o){return 1-Math.sqrt(1-o*o)},Elastic:function(o){return o===0||o===1?o:-Math.pow(2,8*(o-1))*Math.sin(((o-1)*80-7.5)*Math.PI/15)},Back:function(o){return o*o*(3*o-2)},Bounce:function(r){var o,q=4;while(r<((o=Math.pow(2,--q))-1)/11){}return 1/Math.pow(4,3-q)-7.5625*Math.pow((o*3-2)/22-r,2)}});i.each(k,function(p,o){i.easing["easeIn"+p]=o;i.easing["easeOut"+p]=function(q){return 1-o(1-q)};i.easing["easeInOut"+p]=function(q){return q<0.5?o(q*2)/2:o(q*-2+2)/-2+1}})})(jQuery);(function(g){g.ui.timepicker=g.ui.timepicker||{};if(g.ui.timepicker.version){return}g.extend(g.ui,{timepicker:{version:"1.0.5"}});function c(){this.regional=[];this.regional[""]={currentText:"Now",closeText:"Done",ampm:false,amNames:["AM","A"],pmNames:["PM","P"],timeFormat:"hh:mm tt",timeSuffix:"",timeOnlyTitle:"Choose Time",timeText:"Time",hourText:"Hour",minuteText:"Minute",secondText:"Second",millisecText:"Millisecond",timezoneText:"Time Zone",isRTL:false};this._defaults={showButtonPanel:true,timeOnly:false,showHour:true,showMinute:true,showSecond:false,showMillisec:false,showTimezone:false,showTime:true,stepHour:1,stepMinute:1,stepSecond:1,stepMillisec:1,hour:0,minute:0,second:0,millisec:0,timezone:null,useLocalTimezone:false,defaultTimezone:"+0000",hourMin:0,minuteMin:0,secondMin:0,millisecMin:0,hourMax:23,minuteMax:59,secondMax:59,millisecMax:999,minDateTime:null,maxDateTime:null,onSelect:null,hourGrid:0,minuteGrid:0,secondGrid:0,millisecGrid:0,alwaysSetTime:true,separator:" ",altFieldTimeOnly:true,altSeparator:null,altTimeSuffix:null,showTimepicker:true,timezoneIso8601:false,timezoneList:null,addSliderAccess:false,sliderAccessArgs:null,controlType:"slider",defaultValue:null,beforeShowTime:null};g.extend(this._defaults,this.regional[""])}g.extend(c.prototype,{$input:null,$altInput:null,$timeObj:null,inst:null,hour_slider:null,minute_slider:null,second_slider:null,millisec_slider:null,timezone_select:null,hour:0,minute:0,second:0,millisec:0,timezone:null,defaultTimezone:"+0000",hourMinOriginal:null,minuteMinOriginal:null,secondMinOriginal:null,millisecMinOriginal:null,hourMaxOriginal:null,minuteMaxOriginal:null,secondMaxOriginal:null,millisecMaxOriginal:null,ampm:"",formattedDate:"",formattedTime:"",formattedDateTime:"",timezoneList:null,units:["hour","minute","second","millisec"],control:null,setDefaults:function(i){b(this._defaults,i||{});return this},_newInst:function(r,j){var p=new c(),n={},u={},s,l;for(var q in this._defaults){if(this._defaults.hasOwnProperty(q)){var m=r.attr("time:"+q);if(m){try{n[q]=Fai.fkEval(m)}catch(k){n[q]=m}}}}s={beforeShow:function(o,i){if(g.isFunction(p._defaults.evnts.beforeShow)){return p._defaults.evnts.beforeShow.call(r[0],o,i,p)}},onChangeMonthYear:function(o,v,i){if(!i.settings.autoChangeMonthYear){return}p._updateDateTime(i);if(g.isFunction(p._defaults.evnts.onChangeMonthYear)){p._defaults.evnts.onChangeMonthYear.call(r[0],o,v,i,p)}},onClose:function(o,i){if(p.timeDefined===true&&r.val()!==""){p._updateDateTime(i)}if(g.isFunction(p._defaults.evnts.onClose)){p._defaults.evnts.onClose.call(r[0],o,i,p)}}};for(l in s){if(s.hasOwnProperty(l)){u[l]=j[l]||null}}p._defaults=g.extend({},this._defaults,n,j,s,{evnts:u,timepicker:p});p.amNames=g.map(p._defaults.amNames,function(i){return i.toUpperCase()});p.pmNames=g.map(p._defaults.pmNames,function(i){return i.toUpperCase()});if(typeof(p._defaults.controlType)==="string"){if(p._defaults.controlType=="slider"&&g.fn.slider===undefined){p._defaults.controlType="select"}p.control=p._controls[p._defaults.controlType]}else{p.control=p._defaults.controlType}if(p._defaults.timezoneList===null){var t=["-1200","-1100","-1000","-0930","-0900","-0800","-0700","-0600","-0500","-0430","-0400","-0330","-0300","-0200","-0100","+0000","+0100","+0200","+0300","+0330","+0400","+0430","+0500","+0530","+0545","+0600","+0630","+0700","+0800","+0845","+0900","+0930","+1000","+1030","+1100","+1130","+1200","+1245","+1300","+1400"];if(p._defaults.timezoneIso8601){t=g.map(t,function(i){return i=="+0000"?"Z":(i.substring(0,3)+":"+i.substring(3))})}p._defaults.timezoneList=t}p.timezone=p._defaults.timezone;p.hour=p._defaults.hour;p.minute=p._defaults.minute;p.second=p._defaults.second;p.millisec=p._defaults.millisec;p.ampm="";p.$input=r;if(j.altField){p.$altInput=g(j.altField).css({cursor:"pointer"}).focus(function(){r.trigger("focus")})}if(p._defaults.minDate===0||p._defaults.minDateTime===0){p._defaults.minDate=new Date()}if(p._defaults.maxDate===0||p._defaults.maxDateTime===0){p._defaults.maxDate=new Date()}if(p._defaults.minDate!==undefined&&p._defaults.minDate instanceof Date){p._defaults.minDateTime=new Date(p._defaults.minDate.getTime())}if(p._defaults.minDateTime!==undefined&&p._defaults.minDateTime instanceof Date){p._defaults.minDate=new Date(p._defaults.minDateTime.getTime())}if(p._defaults.maxDate!==undefined&&p._defaults.maxDate instanceof Date){p._defaults.maxDateTime=new Date(p._defaults.maxDate.getTime())}if(p._defaults.maxDateTime!==undefined&&p._defaults.maxDateTime instanceof Date){p._defaults.maxDate=new Date(p._defaults.maxDateTime.getTime())}p.$input.bind("focus",function(){p._onFocus()});return p},_addTimePicker:function(j){var i=(this.$altInput&&this._defaults.altFieldTimeOnly)?this.$input.val()+" "+this.$altInput.val():this.$input.val();this.timeDefined=this._parseTime(i);this._limitMinMaxDateTime(j,false);this._injectTimePicker()},_parseTime:function(k,j){if(!this.inst){this.inst=g.datepicker._getInst(this.$input[0])}if(j||!this._defaults.timeOnly){var n=g.datepicker._get(this.inst,"dateFormat");try{var i=d(n,this._defaults.timeFormat,k,g.datepicker._getFormatConfig(this.inst),this._defaults);if(!i.timeObj){return false}g.extend(this,i.timeObj)}catch(l){return false}return true}else{var m=g.datepicker.parseTime(this._defaults.timeFormat,k,this._defaults);if(!m){return false}g.extend(this,m);return true}},_injectTimePicker:function(){var w=this.inst.dpDiv,z=this.inst.settings,k=this,u="",n="",E={},r={},x=null;if(w.find("div.ui-timepicker-div").length===0&&z.showTimepicker){var p=' style="display:none;"',s='<div class="ui-timepicker-div'+(z.isRTL?" ui-timepicker-rtl":"")+'"><dl><dt class="ui_tpicker_time_label"'+((z.showTime)?"":p)+">"+z.timeText+'</dt><dd class="ui_tpicker_time"'+((z.showTime)?"":p)+"></dd>";for(var F=0,B=this.units.length;F<B;F++){u=this.units[F];n=u.substr(0,1).toUpperCase()+u.substr(1);E[u]=parseInt((z[u+"Max"]-((z[u+"Max"]-z[u+"Min"])%z["step"+n])),10);r[u]=0;s+='<dt class="ui_tpicker_'+u+'_label"'+((z["show"+n])?"":p)+">"+z[u+"Text"]+'</dt><dd class="ui_tpicker_'+u+'"><div class="ui_tpicker_'+u+'_slider"'+((z["show"+n])?"":p)+"></div>";if(z["show"+n]&&z[u+"Grid"]>0){s+='<div style="padding-left: 1px"><table class="ui-tpicker-grid-label"><tr>';if(u=="hour"){for(var G=z[u+"Min"];G<=E[u];G+=parseInt(z[u+"Grid"],10)){r[u]++;var t=(z.ampm&&G>12)?G-12:G;if(t<10){t="0"+t}if(z.ampm){if(G===0){t=12+"a"}else{if(G<12){t+="a"}else{t+="p"}}}s+='<td data-for="'+u+'">'+t+"</td>"}}else{for(var A=z[u+"Min"];A<=E[u];A+=parseInt(z[u+"Grid"],10)){r[u]++;s+='<td data-for="'+u+'">'+((A<10)?"0":"")+A+"</td>"}}s+="</tr></table></div>"}s+="</dd>"}s+='<dt class="ui_tpicker_timezone_label"'+((z.showTimezone)?"":p)+">"+z.timezoneText+"</dt>";s+='<dd class="ui_tpicker_timezone" '+((z.showTimezone)?"":p)+"></dd>";s+="</dl></div>";var j=g(s);if(z.timeOnly===true){j.prepend('<div class="ui-widget-header ui-helper-clearfix ui-corner-all"><div class="ui-datepicker-title">'+z.timeOnlyTitle+"</div></div>");w.find(".ui-datepicker-header, .ui-datepicker-calendar").hide()}for(var F=0,B=k.units.length;F<B;F++){u=k.units[F];n=u.substr(0,1).toUpperCase()+u.substr(1);k[u+"_slider"]=k.control.create(k,j.find(".ui_tpicker_"+u+"_slider"),u,k[u],z[u+"Min"],E[u],z["step"+n]);if(z["show"+n]&&z[u+"Grid"]>0){x=100*r[u]*z[u+"Grid"]/(E[u]-z[u+"Min"]);j.find(".ui_tpicker_"+u+" table").css({width:x+"%",marginLeft:z.isRTL?"0":((x/(-2*r[u]))+"%"),marginRight:z.isRTL?((x/(-2*r[u]))+"%"):"0",borderCollapse:"collapse"}).find("td").click(function(I){var J=g(this),l=J.html(),o=J.data("for");if(o=="hour"&&z.ampm){var i=l.substring(2).toLowerCase(),m=parseInt(l.substring(0,2),10);if(i=="a"){if(m==12){l=0}else{l=m}}else{if(m==12){l=12}else{l=m+12}}}k.control.value(k,k[o+"_slider"],parseInt(l,10));k._onTimeChange();k._onSelectHandler()}).css({cursor:"pointer",width:(100/r[u])+"%",textAlign:"center",overflow:"hidden"})}}this.timezone_select=j.find(".ui_tpicker_timezone").append("<select></select>").find("select");g.fn.append.apply(this.timezone_select,g.map(z.timezoneList,function(l,i){return g("<option />").val(typeof l=="object"?l.value:l).text(typeof l=="object"?l.label:l)}));if(typeof(this.timezone)!="undefined"&&this.timezone!==null&&this.timezone!==""){var H=new Date(this.inst.selectedYear,this.inst.selectedMonth,this.inst.selectedDay,12);var D=g.timepicker.timeZoneOffsetString(H);if(D==this.timezone){h(k)}else{this.timezone_select.val(this.timezone)}}else{if(typeof(this.hour)!="undefined"&&this.hour!==null&&this.hour!==""){this.timezone_select.val(z.defaultTimezone)}else{h(k)}}this.timezone_select.change(function(){k._defaults.useLocalTimezone=false;k._onTimeChange()});var v=w.find(".ui-datepicker-buttonpane");if(v.length){v.before(j)}else{w.append(j)}this.$timeObj=j.find(".ui_tpicker_time");if(this.inst!==null){var y=this.timeDefined;this._onTimeChange();this.timeDefined=y}if(this._defaults.addSliderAccess){var C=this._defaults.sliderAccessArgs,q=this._defaults.isRTL;C.isRTL=q;setTimeout(function(){if(j.find(".ui-slider-access").length===0){j.find(".ui-slider:visible").sliderAccess(C);var i=j.find(".ui-slider-access:eq(0)").outerWidth(true);if(i){j.find("table:visible").each(function(){var m=g(this),l=m.outerWidth(),K=m.css(q?"marginRight":"marginLeft").toString().replace("%",""),J=l-i,I=((K*J)/l)+"%",o={width:J,marginRight:0,marginLeft:0};o[q?"marginRight":"marginLeft"]=I;m.css(o)})}}},10)}}},_limitMinMaxDateTime:function(s,t){var j=this._defaults,q=new Date(s.selectedYear,s.selectedMonth,s.selectedDay);if(!this._defaults.showTimepicker){return}if(g.datepicker._get(s,"minDateTime")!==null&&g.datepicker._get(s,"minDateTime")!==undefined&&q){var i=g.datepicker._get(s,"minDateTime"),r=new Date(i.getFullYear(),i.getMonth(),i.getDate(),0,0,0,0);if(this.hourMinOriginal===null||this.minuteMinOriginal===null||this.secondMinOriginal===null||this.millisecMinOriginal===null){this.hourMinOriginal=j.hourMin;this.minuteMinOriginal=j.minuteMin;this.secondMinOriginal=j.secondMin;this.millisecMinOriginal=j.millisecMin}if(s.settings.timeOnly||r.getTime()==q.getTime()){this._defaults.hourMin=i.getHours();if(this.hour<=this._defaults.hourMin){this.hour=this._defaults.hourMin;this._defaults.minuteMin=i.getMinutes();if(this.minute<=this._defaults.minuteMin){this.minute=this._defaults.minuteMin;this._defaults.secondMin=i.getSeconds();if(this.second<=this._defaults.secondMin){this.second=this._defaults.secondMin;this._defaults.millisecMin=i.getMilliseconds()}else{if(this.millisec<this._defaults.millisecMin){this.millisec=this._defaults.millisecMin}this._defaults.millisecMin=this.millisecMinOriginal}}else{this._defaults.secondMin=this.secondMinOriginal;this._defaults.millisecMin=this.millisecMinOriginal}}else{this._defaults.minuteMin=this.minuteMinOriginal;this._defaults.secondMin=this.secondMinOriginal;this._defaults.millisecMin=this.millisecMinOriginal}}else{this._defaults.hourMin=this.hourMinOriginal;this._defaults.minuteMin=this.minuteMinOriginal;this._defaults.secondMin=this.secondMinOriginal;this._defaults.millisecMin=this.millisecMinOriginal}}if(g.datepicker._get(s,"maxDateTime")!==null&&g.datepicker._get(s,"maxDateTime")!==undefined&&q){var u=g.datepicker._get(s,"maxDateTime"),l=new Date(u.getFullYear(),u.getMonth(),u.getDate(),0,0,0,0);if(this.hourMaxOriginal===null||this.minuteMaxOriginal===null||this.secondMaxOriginal===null){this.hourMaxOriginal=j.hourMax;this.minuteMaxOriginal=j.minuteMax;this.secondMaxOriginal=j.secondMax;this.millisecMaxOriginal=j.millisecMax}if(s.settings.timeOnly||l.getTime()==q.getTime()){this._defaults.hourMax=u.getHours();if(this.hour>=this._defaults.hourMax){this.hour=this._defaults.hourMax;this._defaults.minuteMax=u.getMinutes();if(this.minute>=this._defaults.minuteMax){this.minute=this._defaults.minuteMax;this._defaults.secondMax=u.getSeconds()}else{if(this.second>=this._defaults.secondMax){this.second=this._defaults.secondMax;this._defaults.millisecMax=u.getMilliseconds()}else{if(this.millisec>this._defaults.millisecMax){this.millisec=this._defaults.millisecMax}this._defaults.millisecMax=this.millisecMaxOriginal}}}else{this._defaults.minuteMax=this.minuteMaxOriginal;this._defaults.secondMax=this.secondMaxOriginal;this._defaults.millisecMax=this.millisecMaxOriginal}}else{this._defaults.hourMax=this.hourMaxOriginal;this._defaults.minuteMax=this.minuteMaxOriginal;this._defaults.secondMax=this.secondMaxOriginal;this._defaults.millisecMax=this.millisecMaxOriginal}}if(t!==undefined&&t===true){var m=parseInt((this._defaults.hourMax-((this._defaults.hourMax-this._defaults.hourMin)%this._defaults.stepHour)),10),n=parseInt((this._defaults.minuteMax-((this._defaults.minuteMax-this._defaults.minuteMin)%this._defaults.stepMinute)),10),p=parseInt((this._defaults.secondMax-((this._defaults.secondMax-this._defaults.secondMin)%this._defaults.stepSecond)),10),k=parseInt((this._defaults.millisecMax-((this._defaults.millisecMax-this._defaults.millisecMin)%this._defaults.stepMillisec)),10);if(this.hour_slider){this.control.options(this,this.hour_slider,{min:this._defaults.hourMin,max:m});this.control.value(this,this.hour_slider,this.hour)}if(this.minute_slider){this.control.options(this,this.minute_slider,{min:this._defaults.minuteMin,max:n});this.control.value(this,this.minute_slider,this.minute)}if(this.second_slider){this.control.options(this,this.second_slider,{min:this._defaults.secondMin,max:p});this.control.value(this,this.second_slider,this.second)}if(this.millisec_slider){this.control.options(this,this.millisec_slider,{min:this._defaults.millisecMin,max:k});this.control.value(this,this.millisec_slider,this.millisec)}}},_onTimeChange:function(){var i=(this.hour_slider)?this.control.value(this,this.hour_slider):false,q=(this.minute_slider)?this.control.value(this,this.minute_slider):false,k=(this.second_slider)?this.control.value(this,this.second_slider):false,m=(this.millisec_slider)?this.control.value(this,this.millisec_slider):false,n=(this.timezone_select)?this.timezone_select.val():false,p=this._defaults;if(typeof(i)=="object"){i=false}if(typeof(q)=="object"){q=false}if(typeof(k)=="object"){k=false}if(typeof(m)=="object"){m=false}if(typeof(n)=="object"){n=false}if(i!==false){i=parseInt(i,10)}if(q!==false){q=parseInt(q,10)}if(k!==false){k=parseInt(k,10)}if(m!==false){m=parseInt(m,10)}var j=p[i<12?"amNames":"pmNames"][0];var l=this.upDateTimePicker||(i!=this.hour||q!=this.minute||k!=this.second||m!=this.millisec||(this.ampm.length>0&&(i<12)!=(g.inArray(this.ampm.toUpperCase(),this.amNames)!==-1))||((this.timezone===null&&n!=this.defaultTimezone)||(this.timezone!==null&&n!=this.timezone)));if(l){if(i!==false){this.hour=i}if(q!==false){this.minute=q}if(k!==false){this.second=k}if(m!==false){this.millisec=m}if(n!==false){this.timezone=n}if(!this.inst){this.inst=g.datepicker._getInst(this.$input[0])}this._limitMinMaxDateTime(this.inst,true)}if(p.ampm){this.ampm=j}this.formattedTime=g.datepicker.formatTime(this._defaults.timeFormat,this,this._defaults);if(this.$timeObj){this.$timeObj.text(this.formattedTime+p.timeSuffix)}this.timeDefined=true;if(l){this._updateDateTime()}},_onSelectHandler:function(){var i=this._defaults.onSelect||this.inst.settings.onSelect;var j=this.$input?this.$input[0]:null;if(i&&j){i.apply(j,[this.formattedDateTime,this])}},_updateDateTime:function(o){o=this.inst||o;var j=g.datepicker._daylightSavingAdjust(new Date(o.selectedYear,o.selectedMonth,o.selectedDay)),p=g.datepicker._get(o,"dateFormat"),k=g.datepicker._getFormatConfig(o),n=j!==null&&this.timeDefined;this.formattedDate=g.datepicker.formatDate(p,(j===null?new Date():j),k);var i=this.formattedDate;if(this._defaults.timeOnly===true){i=this.formattedTime}else{if(this._defaults.timeOnly!==true&&(this._defaults.alwaysSetTime||n)){i+=this._defaults.separator+this.formattedTime+this._defaults.timeSuffix}}this.formattedDateTime=i;if(!this._defaults.showTimepicker){this.$input.val(this.formattedDate)}else{if(this.$altInput&&this._defaults.altFieldTimeOnly===true){this.$altInput.val(this.formattedTime);this.$input.val(this.formattedDate)}else{if(this.$altInput){this.$input.val(i);var m="",q=this._defaults.altSeparator?this._defaults.altSeparator:this._defaults.separator,l=this._defaults.altTimeSuffix?this._defaults.altTimeSuffix:this._defaults.timeSuffix;if(this._defaults.altFormat){m=g.datepicker.formatDate(this._defaults.altFormat,(j===null?new Date():j),k)}else{m=this.formattedDate}if(m){m+=q}if(this._defaults.altTimeFormat){m+=g.datepicker.formatTime(this._defaults.altTimeFormat,this,this._defaults)+l}else{m+=this.formattedTime+l}this.$altInput.val(m)}else{this.$input.val(i)}}}this.$input.trigger("change")},_onFocus:function(){if(!this.$input.val()&&this._defaults.defaultValue){this.$input.val(this._defaults.defaultValue);var k=g.datepicker._getInst(this.$input.get(0)),i=g.datepicker._get(k,"timepicker");if(i){if(i._defaults.timeOnly&&(k.input.val()!=k.lastVal)){try{g.datepicker._updateDatepicker(k)}catch(j){g.datepicker.log(j)}}}}},_controls:{slider:{create:function(j,o,m,p,k,i,l){var n=j._defaults.isRTL;return o.prop("slide",null).slider({orientation:"horizontal",value:n?p*-1:p,min:n?i*-1:k,max:n?k*-1:i,step:l,slide:function(q,r){j.control.value(j,g(this),n?r.value*-1:r.value);j._onTimeChange()},stop:function(q,r){j._onSelectHandler()}})},options:function(j,m,l,n){if(j._defaults.isRTL){if(typeof(l)=="string"){if(l=="min"||l=="max"){if(n!==undefined){return m.slider(l,n*-1)}return Math.abs(m.slider(l))}return m.slider(l)}var k=l.min,i=l.max;l.min=l.max=null;if(k!==undefined){l.max=k*-1}if(i!==undefined){l.min=i*-1}return m.slider(l)}if(typeof(l)=="string"&&n!==undefined){return m.slider(l,n)}return m.slider(l)},value:function(i,j,k){if(i._defaults.isRTL){if(k!==undefined){return j.slider("value",k*-1)}return Math.abs(j.slider("value"))}if(k!==undefined){return j.slider("value",k)}return j.slider("value")}},select:{create:function(r,q,u,k,o,t,l){var j='<select class="ui-timepicker-select" data-unit="'+u+'" data-min="'+o+'" data-max="'+t+'" data-step="'+l+'">',s=r._defaults.timeFormat.indexOf("t")!==-1?"toLowerCase":"toUpperCase",n=0;for(var p=o;p<=t;p+=l){j+='<option value="'+p+'"'+(p==k?" selected":"")+">";if(u=="hour"&&r._defaults.ampm){n=p%12;if(p===0||p===12){j+="12"}else{if(n<10){j+="0"+n.toString()}else{j+=n}}j+=" "+((p<12)?r._defaults.amNames[0]:r._defaults.pmNames[0])[s]()}else{if(u=="millisec"||p>=10){j+=p}else{j+="0"+p.toString()}}j+="</option>"}j+="</select>";q.children("select").remove();g(j).appendTo(q).change(function(i){r._onTimeChange();r._onSelectHandler()});return q},options:function(i,k,j,m){var l={},n=k.children("select");if(typeof(j)=="string"){if(m===undefined){return n.data(j)}l[j]=m}else{l=j}return i.control.create(i,k,n.data("unit"),n.val(),l.min||n.data("min"),l.max||n.data("max"),l.step||n.data("step"))},value:function(i,j,k){var l=j.children("select");if(k!==undefined){return l.val(k)}return l.val()}},fkControl:{create:function(r,q,u,k,o,t,l){var j='<div class="fk-timepicker-time" data-unit="'+u+'" data-min="'+o+'" data-max="'+t+'" data-step="'+l+'">',v=r.inst.settings.beforeShowTime,s=r._defaults.timeFormat.indexOf("t")!==-1?"toLowerCase":"toUpperCase",n=0,w;j+="<input type='text' class='fk-timepicker-select' value='"+(k!=0?k+"：00":"00：00")+"' _showTime='0' readOnly>";j+="<div class='fk-timeVauleWrap'>";if(q.hasClass("ui_tpicker_hour_slider")){for(var p=o;p<=t;p+=l){w=typeof v=="function"?v(p):true;j+='<span class="fk-timeValue '+(w?"":"fk-timeBan")+'" value="'+p+'"'+(p==k?" selected":"")+">";if(u=="hour"&&r._defaults.ampm){n=p%12;if(p===0||p===12){j+="12：00"}else{if(n<10){j+="0"+n.toString()+"：00"}else{j+=n+"：00"}}j+=" "+((p<12)?r._defaults.amNames[0]:r._defaults.pmNames[0])[s]()}else{if(u=="millisec"||p>=10){j+=p+"：00"}else{j+=(p>=10)?p+"：00":"0"+p+"：00"}}j+="</span>"}}j+="</div>";j+="</div>";q.children(".fk-timepicker-time").remove();g(j).appendTo(q);q.find(".fk-timepicker-time").off("click.time").on("click.time",function(y){var x=g(this),m=g(this).find(".fk-timeVauleWrap"),i=g(this).find(".fk-timepicker-select");if(parseInt(i.attr("_showTime"))==0){m.show();i.attr("_showTime",1).addClass("f-select")}else{m.hide();i.attr("_showTime",0).removeClass("f-select");i}});q.find(".fk-timeVauleWrap").on("click.select",".fk-timeValue",function(m){var i=g(this).html();q.find(".fk-timepicker-select").val(i).attr("_showTime","0").removeClass(".f-select");r.upDateTimePicker=(r.inst&&r.inst.settings&&r.inst.settings.minDate&&r.inst.settings.minDate.getHours()==parseInt(i)?true:false);r._onTimeChange();r._onSelectHandler();q.find(".fk-timeVauleWrap").hide();if(r.$input){r.$input.datetimepicker("hide")}});return q},options:function(i,k,j,m){var l={},n=k.children(".fk-timepicker-time");if(typeof(j)=="string"){if(m===undefined){return n.data(j)}l[j]=m}else{l=j}return i.control.create(i,k,n.data("unit"),n.val(),l.min||n.data("min"),l.max||n.data("max"),l.step||n.data("step"))},value:function(i,k,l){var m=k.find(".fk-timepicker-select"),j;if(l!==undefined){if(k.hasClass("ui_tpicker_hour_slider")){if(l>=10){j=l+"：00"}else{j="0"+l+"：00"}}else{j=l}}return j?m.val(j):m.val()}}}});g.fn.extend({timepicker:function(j){j=j||{};var i=Array.prototype.slice.call(arguments);if(typeof j=="object"){i[0]=g.extend(j,{timeOnly:true})}return g(this).each(function(){g.fn.datetimepicker.apply(g(this),i)})},datetimepicker:function(j){j=j||{};var i=arguments;if(typeof(j)=="string"){if(j=="getDate"){return g.fn.datepicker.apply(g(this[0]),i)}else{return this.each(function(){var k=g(this);k.datepicker.apply(k,i)})}}else{return this.each(function(){var k=g(this);k.datepicker(g.timepicker._newInst(k,j)._defaults)})}}});g.datepicker.parseDateTime=function(j,o,i,n,m){var k=d(j,o,i,n,m);if(k.timeObj){var l=k.timeObj;k.date.setHours(l.hour,l.minute,l.second,l.millisec)}return k.date};g.datepicker.parseTime=function(p,i,u){var j=function(v,o){var w=[];if(v){g.merge(w,v)}if(o){g.merge(w,o)}w=g.map(w,function(x){return x.replace(/[.*+?|()\[\]{}\\]/g,"\\$&")});return"("+w.join("|")+")?"};var l=function(x){var w=x.toLowerCase().match(/(h{1,2}|m{1,2}|s{1,2}|l{1}|t{1,2}|z|'.*?')/g),v={h:-1,m:-1,s:-1,l:-1,t:-1,z:-1};if(w){for(var o=0;o<w.length;o++){if(v[w[o].toString().charAt(0)]==-1){v[w[o].toString().charAt(0)]=o+1}}}return v};var k=b(b({},g.timepicker._defaults),u||{});var t="^"+p.toString().replace(/(hh?|mm?|ss?|[tT]{1,2}|[lz]|'.*?')/g,function(o){switch(o.charAt(0).toLowerCase()){case"h":return"(\\d?\\d)";case"m":return"(\\d?\\d)";case"s":return"(\\d?\\d)";case"l":return"(\\d?\\d?\\d)";case"z":return"(z|[-+]\\d\\d:?\\d\\d|\\S+)?";case"t":return j(k.amNames,k.pmNames);default:return"("+o.replace(/\'/g,"").replace(/(\.|\$|\^|\\|\/|\(|\)|\[|\]|\?|\+|\*)/g,function(v){return"\\"+v})+")?"}}).replace(/\s/g,"\\s?")+k.timeSuffix+"$",m=l(p),r="",s;s=i.match(new RegExp(t,"i"));var q={hour:0,minute:0,second:0,millisec:0};if(s){if(m.t!==-1){if(s[m.t]===undefined||s[m.t].length===0){r="";q.ampm=""}else{r=g.inArray(s[m.t].toUpperCase(),k.amNames)!==-1?"AM":"PM";q.ampm=k[r=="AM"?"amNames":"pmNames"][0]}}if(m.h!==-1){if(r=="AM"&&s[m.h]=="12"){q.hour=0}else{if(r=="PM"&&s[m.h]!="12"){q.hour=parseInt(s[m.h],10)+12}else{q.hour=Number(s[m.h])}}}if(m.m!==-1){q.minute=Number(s[m.m])}if(m.s!==-1){q.second=Number(s[m.s])}if(m.l!==-1){q.millisec=Number(s[m.l])}if(m.z!==-1&&s[m.z]!==undefined){var n=s[m.z].toUpperCase();switch(n.length){case 1:n=k.timezoneIso8601?"Z":"+0000";break;case 5:if(k.timezoneIso8601){n=n.substring(1)=="0000"?"Z":n.substring(0,3)+":"+n.substring(3)}break;case 6:if(!k.timezoneIso8601){n=n=="Z"||n.substring(1)=="00:00"?"+0000":n.replace(/:/,"")}else{if(n.substring(1)=="00:00"){n="Z"}}break}q.timezone=n}return q}return false};g.datepicker.formatTime=function(m,l,k){k=k||{};k=g.extend({},g.timepicker._defaults,k);l=g.extend({hour:0,minute:0,second:0,millisec:0,timezone:"+0000"},l);var n=m;var j=k.amNames[0];var i=parseInt(l.hour,10);if(k.ampm){if(i>11){j=k.pmNames[0];if(i>12){i=i%12}}if(i===0){i=12}}n=n.replace(/(?:hh?|mm?|ss?|[tT]{1,2}|[lz]|'.*?')/g,function(o){switch(o.toLowerCase()){case"hh":return("0"+i).slice(-2);case"h":return i;case"mm":return("0"+l.minute).slice(-2);case"m":return l.minute;case"ss":return("0"+l.second).slice(-2);case"s":return l.second;case"l":return("00"+l.millisec).slice(-3);case"z":return l.timezone===null?k.defaultTimezone:l.timezone;case"t":case"tt":if(k.ampm){if(o.length==1){j=j.charAt(0)}return o.charAt(0)==="T"?j.toUpperCase():j.toLowerCase()}return"";default:return o.replace(/\'/g,"")||"'"}});n=g.trim(n);return n};g.datepicker._base_selectDate=g.datepicker._selectDate;g.datepicker._selectDate=function(l,i){var k=this._getInst(g(l)[0]),j=this._get(k,"timepicker");if(j){j._limitMinMaxDateTime(k,true);k.inline=k.stay_open=true;this._base_selectDate(l,i);k.inline=k.stay_open=false;this._notifyChange(k);this._updateDatepicker(k)}else{this._base_selectDate(l,i)}};g.datepicker._base_updateDatepicker=g.datepicker._updateDatepicker;g.datepicker._updateDatepicker=function(l){var i=l.input[0];if(g.datepicker._curInst&&g.datepicker._curInst!=l&&g.datepicker._datepickerShowing&&g.datepicker._lastInput!=i){return}if(typeof(l.stay_open)!=="boolean"||l.stay_open===false){this._base_updateDatepicker(l);var k=this._get(l,"timepicker");if(k){k._addTimePicker(l);l.dpDiv.off("click.time").on("click.time",function(n){var m=l.dpDiv.find(".ui_tpicker_hour .fk-timeVauleWrap");if(!m.is(":visible")&&g(n.target).hasClass("fk-timeVauleWrap")||g(n.target).hasClass("fk-timepicker-select")){if(g(".ui_tpicker_hour .mCustomScrollbar").length<1){g(".ui_tpicker_hour .fk-timeVauleWrap").mCustomScrollbar({theme:"fk-gray",advanced:{updateOnContentResize:true},axis:"y"})}return}m.hide();l.dpDiv.find(".fk-timepicker-select").removeClass("f-select").attr("_showTime",0)});if(k._defaults.useLocalTimezone){var j=new Date(l.selectedYear,l.selectedMonth,l.selectedDay,12);h(k,j);k._onTimeChange()}}}};g.datepicker._base_doKeyPress=g.datepicker._doKeyPress;g.datepicker._doKeyPress=function(n){var o=g.datepicker._getInst(n.target),l=g.datepicker._get(o,"timepicker");if(l){if(g.datepicker._get(o,"constrainInput")){var k=l._defaults.ampm,j=g.datepicker._possibleChars(g.datepicker._get(o,"dateFormat")),i=l._defaults.timeFormat.toString().replace(/[hms]/g,"").replace(/TT/g,k?"APM":"").replace(/Tt/g,k?"AaPpMm":"").replace(/tT/g,k?"AaPpMm":"").replace(/T/g,k?"AP":"").replace(/tt/g,k?"apm":"").replace(/t/g,k?"ap":"")+" "+l._defaults.separator+l._defaults.timeSuffix+(l._defaults.showTimezone?l._defaults.timezoneList.join(""):"")+(l._defaults.amNames.join(""))+(l._defaults.pmNames.join(""))+j,m=String.fromCharCode(n.charCode===undefined?n.keyCode:n.charCode);return n.ctrlKey||(m<" "||!j||i.indexOf(m)>-1)}}return g.datepicker._base_doKeyPress(n)};g.datepicker._base_updateAlternate=g.datepicker._updateAlternate;g.datepicker._updateAlternate=function(o){var p=this._get(o,"timepicker");if(p){var i=p._defaults.altField;if(i){var m=p._defaults.altFormat||p._defaults.dateFormat,j=this._getDate(o),k=g.datepicker._getFormatConfig(o),q="",r=p._defaults.altSeparator?p._defaults.altSeparator:p._defaults.separator,n=p._defaults.altTimeSuffix?p._defaults.altTimeSuffix:p._defaults.timeSuffix,l=p._defaults.altTimeFormat!==undefined?p._defaults.altTimeFormat:p._defaults.timeFormat;q+=g.datepicker.formatTime(l,p,p._defaults)+n;if(!p._defaults.timeOnly&&!p._defaults.altFieldTimeOnly){if(p._defaults.altFormat){q=g.datepicker.formatDate(p._defaults.altFormat,(j===null?new Date():j),k)+r+q}else{q=p.formattedDate+r+q}}g(i).val(q)}}else{g.datepicker._base_updateAlternate(o)}};g.datepicker._base_doKeyUp=g.datepicker._doKeyUp;g.datepicker._doKeyUp=function(k){var l=g.datepicker._getInst(k.target),i=g.datepicker._get(l,"timepicker");if(i){if(i._defaults.timeOnly&&(l.input.val()!=l.lastVal)){try{g.datepicker._updateDatepicker(l)}catch(j){g.datepicker.log(j)}}}return g.datepicker._base_doKeyUp(k)};g.datepicker._disableTimepickerDatepicker=function(k){var j=this._getInst(k);if(!j){return}var i=this._get(j,"timepicker");g(k).datepicker("getDate");if(i){i._defaults.showTimepicker=false;i._updateDateTime(j)}};g.datepicker._enableTimepickerDatepicker=function(k){var j=this._getInst(k);if(!j){return}var i=this._get(j,"timepicker");g(k).datepicker("getDate");if(i){i._defaults.showTimepicker=true;i._addTimePicker(j);i._updateDateTime(j)}};g.datepicker._setTimeDatepicker=function(m,k,j){var l=this._getInst(m);if(!l){return}var i=this._get(l,"timepicker");if(i){this._setDateFromField(l);var n;if(k){if(typeof k=="string"){i._parseTime(k,j);n=new Date();n.setHours(i.hour,i.minute,i.second,i.millisec)}else{n=new Date(k.getTime())}if(n.toString()=="Invalid Date"){n=undefined}this._setTime(l,n)}}};g.datepicker._base_setDateDatepicker=g.datepicker._setDateDatepicker;g.datepicker._setDateDatepicker=function(k,i){var j=this._getInst(k);if(!j){return}var l=(i instanceof Date)?new Date(i.getTime()):i;this._updateDatepicker(j);this._base_setDateDatepicker.apply(this,arguments);this._setTimeDatepicker(k,l,true)};g.datepicker._base_getDateDatepicker=g.datepicker._getDateDatepicker;g.datepicker._getDateDatepicker=function(m,k){var l=this._getInst(m);if(!l){return}var j=this._get(l,"timepicker");if(j){if(l.lastVal===undefined){this._setDateFromField(l,k)}var i=this._getDate(l);if(i&&j._parseTime(g(m).val(),j.timeOnly)){i.setHours(j.hour,j.minute,j.second,j.millisec)}return i}return this._base_getDateDatepicker(m,k)};g.datepicker._base_parseDate=g.datepicker.parseDate;g.datepicker.parseDate=function(m,l,j){var i;try{i=this._base_parseDate(m,l,j)}catch(k){i=this._base_parseDate(m,l.substring(0,l.length-(k.length-k.indexOf(":")-2)),j)}return i};g.datepicker._base_formatDate=g.datepicker._formatDate;g.datepicker._formatDate=function(l,i,m,k){var j=this._get(l,"timepicker");if(j){j._updateDateTime(l);return j.$input.val()}return this._base_formatDate(l,i,m,k)};g.datepicker._base_optionDatepicker=g.datepicker._optionDatepicker;g.datepicker._optionDatepicker=function(o,j,r){var m=this._getInst(o),k;if(!m){return null}var n=this._get(m,"timepicker");if(n){var l=null,q=null,p=null,s=n._defaults.evnts,t={},i;if(typeof j=="string"){if(j==="minDate"||j==="minDateTime"){l=r}else{if(j==="maxDate"||j==="maxDateTime"){q=r}else{if(j==="onSelect"){p=r}else{if(s.hasOwnProperty(j)){if(typeof(r)==="undefined"){return s[j]}t[j]=r;k={}}}}}}else{if(typeof j=="object"){if(j.minDate){l=j.minDate}else{if(j.minDateTime){l=j.minDateTime}else{if(j.maxDate){q=j.maxDate}else{if(j.maxDateTime){q=j.maxDateTime}}}}for(i in s){if(s.hasOwnProperty(i)&&j[i]){t[i]=j[i]}}}}for(i in t){if(t.hasOwnProperty(i)){s[i]=t[i];if(!k){k=g.extend({},j)}delete k[i]}}if(k&&f(k)){return}if(l){if(l===0){l=new Date()}else{l=new Date(l)}n._defaults.minDate=l;n._defaults.minDateTime=l}else{if(q){if(q===0){q=new Date()}else{q=new Date(q)}n._defaults.maxDate=q;n._defaults.maxDateTime=q}else{if(p){n._defaults.onSelect=p}}}}if(r===undefined){return this._base_optionDatepicker.call(g.datepicker,o,j)}return this._base_optionDatepicker.call(g.datepicker,o,k||j,r)};function f(i){var j;for(j in i){if(i.hasOwnProperty(i)){return false}}return true}function b(k,j){g.extend(k,j);for(var i in j){if(j[i]===null||j[i]===undefined){k[i]=j[i]}}return k}var e=function(k,j,q,r){try{var p=r&&r.separator?r.separator:g.timepicker._defaults.separator,v=r&&r.timeFormat?r.timeFormat:g.timepicker._defaults.timeFormat,s=r&&r.ampm?r.ampm:g.timepicker._defaults.ampm,u=v.split(p),n=u.length,m=j.split(p),o=m.length;if(!s){u=g.trim(v.replace(/t/gi,"")).split(p);n=u.length}if(o>1){return[m.splice(0,o-n).join(p),m.splice(0,n).join(p)]}}catch(l){if(l.indexOf(":")>=0){var t=j.length-(l.length-l.indexOf(":")-2),i=j.substring(t);return[g.trim(j.substring(0,t)),g.trim(j.substring(t))]}else{throw l}}return[j,""]};var d=function(k,m,j,n,p){var l;var o=e(k,j,n,p);l=g.datepicker._base_parseDate(k,o[0],n);if(o[1]!==""){var i=o[1],q=g.datepicker.parseTime(m,i,p);if(q===null){throw"Wrong time format"}return{date:l,timeObj:q}}else{return{date:l}}};var h=function(l,k){if(l&&l.timezone_select){l._defaults.useLocalTimezone=true;var j=typeof k!=="undefined"?k:new Date();var i=g.timepicker.timeZoneOffsetString(j);if(l._defaults.timezoneIso8601){i=i.substring(0,3)+":"+i.substring(3)}l.timezone_select.val(i)}};g.timepicker=new c();g.timepicker.timeZoneOffsetString=function(j){var l=j.getTimezoneOffset()*-1,k=l%60,i=(l-k)/60;return(l>=0?"+":"-")+("0"+(i*101).toString()).substr(-2)+("0"+(k*101).toString()).substr(-2)};g.timepicker.timeRange=function(k,i,j){return g.timepicker.handleRange("timepicker",k,i,j)};g.timepicker.dateTimeRange=function(k,i,j){g.timepicker.dateRange(k,i,j,"datetimepicker")};g.timepicker.dateRange=function(k,i,j,l){l=l||"datepicker";g.timepicker.handleRange(l,k,i,j)};g.timepicker.handleRange=function(n,l,i,j){g.fn[n].call(l,g.extend({onClose:function(p,o){m(this,i,p)},onSelect:function(o){k(this,i,"minDate")}},j,j.start));g.fn[n].call(i,g.extend({onClose:function(p,o){m(this,l,p)},onSelect:function(o){k(this,l,"maxDate")}},j,j.end));if(n!="timepicker"&&j.reformat){g([l,i]).each(function(){var p=g(this)[n].call(g(this),"option","dateFormat"),o=new Date(g(this).val());if(g(this).val()&&o){g(this).val(g.datepicker.formatDate(p,o))}})}m(l,i,l.val());function m(q,o,p){if(o.val()&&(new Date(l.val())>new Date(i.val()))){o.val(p)}}k(l,i,"minDate");k(i,l,"maxDate");function k(r,o,q){if(!g(r).val()){return}var p=g(r)[n].call(g(r),"getDate");if(p.getTime){g(o)[n].call(g(o),"option",q,p)}}return g([l.get(0),i.get(0)])};g.timepicker.version="1.0.5"})(jQuery);jQuery(function(b){b.timepicker.regional["zh-CN"]={closeText:"关闭",prevText:"&#x3c;上月",nextText:"下月&#x3e;",currentText:"今天",monthNames:["1月","2月","3月","4月","5月","6月","7月","8月","9月","10月","11月","12月"],monthNamesShort:["1月","2月","3月","4月","5月","6月","7月","8月","9月","10月","11月","12月"],dayNames:["星期日","星期一","星期二","星期三","星期四","星期五","星期六"],dayNamesShort:["周日","周一","周二","周三","周四","周五","周六"],dayNamesMin:["日","一","二","三","四","五","六"],weekHeader:"周",dateFormat:"yy-mm-dd",firstDay:1,isRTL:false,showMonthAfterYear:true,yearSuffix:"年"};b.timepicker.setDefaults(b.datepicker.regional["zh-CN"])});